((
  ...
  try {
    ...
    return `${playerName} is ${fullStreamEloChange >= 0 ? 'UP' : 'DOWN'} ${fullStreamEloChange}RR this stream. Currently ${winCountThisStream}W - ${lossCountThisStream}L - ${drawCountThisStream}D. | ${currentTierPatched} ${rankingInTier}`;
  } catch (e) {
